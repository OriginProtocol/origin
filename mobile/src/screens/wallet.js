...
class WalletScreen extends Component {
  ...
  render() {
    ...
    return hasActiveAccount ? this.renderBalances() : this.renderNoActiveAddress()
  }

  renderNoActiveAddress() {
    return (
      <>
        <Text style={{ ...styles.listHeader, fontSize: 16, marginVertical: 50 }}>
          No accounts found.
        </Text>
        <OriginButton
          size="large"
