      ...
      <div className="action-card">
        ...
        <div className="form-group">
          <div className="terms-wrapper">
            The recipient acknowledges that he, she or it has been advised that
            the offers and sales of OGN have not been registered under any
            country’s securities laws and, therefore, cannot be resold except in
            ...
            deemed to be securities offerings in the United States at launch.
            While we plan to work towards meeting the standards set by various
            ...
            in those jurisdictions, we cannot assure you that those standards
            have been met as of now. In recognition of the foregoing, the
            recipient covenants to the Company that it will comply with all
