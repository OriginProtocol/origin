...
describe('June campaign rules', () => {
  ...
  before(() => {
    ...
    this.userC = '0x789' // User C has legacy event from prior the start of June campaign.
  ...
  it(`Legacy user at level 2 should not get reward for new attestations`, async () => {
    this.events.push(
      {
        id: 'C3',
