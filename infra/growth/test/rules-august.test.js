...
describe('August campaign rules', () => {
  ...
  before(() => {
    ...
    this.crules = new CampaignRules(row, augustConfig)
    ...
    expect(this.crules.levels[2].rules.length).to.equal(2) // TODO: adjust as more listings get added to the rule.
