...
describe('December campaign rules', () => {
  ...
  before(() => {
    ...
    this.crules = new CampaignRules(row, decemberConfig)
  ...
  it(`Should not get a reward when a mobile app is installed`, async () => {
    this.events.push(
      {
        id: 12,
