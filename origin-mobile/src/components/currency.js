...
export default class Currency extends Component {
  render() {
    const { abbreviation, balance, imageSource, labelColor, name, vertical, withAdd, onPress } = this.props
      ...
      <View style={{ ...styles.container, ...styles.vertical }}>
        <View style={{ height: 28 }}>
          ...
          <View style={styles.colored}>
            ...
            <Text style={{ ...styles.abbreviation, ...styles.abbreviationLarge, color: labelColor }}>{abbreviation}</Text>
          </View>
        </View>
        <View style={styles.right}>
          ...
          <Text style={{ ...styles.balance, ...styles.balanceLarge }}>{Number(balance).toFixed(5)}</Text>
        </View>
      </View>
    ) : (
