...
const Privacy = () => {
  return (
    <div className="privacy-policy">
      ...
      <br />
      <br />
      <b>Information You Give Us.</b> We collect your‎ name, email address as
      well as other information you directly give us on our Site.
      <br />
      <br />
      <b>Information We Get From Others.</b> We may get information about you
      from other sources. We may add this to information we get from this Site.
      <br />
      <br />
      <b>Information Automatically Collected.</b> We automatically log
      information about you and your computer. For example, when visiting our
      Site, we log your computer operating system type, browser type, browser
      ...
      We may also share aggregated and/or anonymized data with others for their
      own uses.
      <br />
      ...
      browser settings. Many browsers are set to accept cookies until you change
      your settings. If you remove or reject our cookies, it could affect how
      ...
      We may change this privacy policy at anytime. If we make any changes, we
