...
export function changesToPublishExist({ props, state }) {
  ...
  return !(
    ...
    !!profile.emailVerified === (!!state.emailAttestation || !!state.emailVerified) &&
    !!profile.phoneVerified === (!!state.phoneAttestation || !!state.phoneVerified) &&
    !!profile.facebookVerified === (!!state.facebookAttestation || !!state.facebookVerified) &&
    !!profile.twitterVerified === (!!state.twitterAttestation || !!state.twitterVerified) &&
    !!profile.airbnbVerified === (!!state.airbnbAttestation || !!state.airbnbVerified)
  )
}
