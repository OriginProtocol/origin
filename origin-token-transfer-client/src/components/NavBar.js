...
class NavBar extends Component {
  handleLogout = () => {
    fetch('/api/logout', { method: 'POST', cache: 'no-store' }).then(() =>
      this.props.setSessionEmail(null)
    )
  }
    ...
    return (
      <nav className="bp3-navbar bp3-dark">
        <div className="bp3-navbar-group bp3-align-left">
          ...
          <button
            className="bp3-button bp3-minimal bp3-icon-dollar"
            onClick={() => history.push('/grants')}
          >
            Token Grants
          </button>
          <button
            className="bp3-button bp3-minimal bp3-icon-timeline-events"
        ...
        <div className="bp3-navbar-group bp3-align-right">
          <div className="bp3-navbar-heading">
            {sessionEmail} {/* eslint-disable-next-line */}(
