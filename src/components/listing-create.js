...
class ListingCreate extends Component {
  ...
  async onSubmitListing(formListing, selectedSchemaType) {
    try {
      ...
      const transactionReceipt = await origin.listings.create(
        formListing.formData,
        selectedSchemaType
      )
      this.setState({ step: this.STEP.PROCESSING })
      // Submitted to blockchain, now wait for confirmation
      await origin.contractService.waitTransactionFinished(
              ...
              <div className="col-md-5 offset-md-2">
                <div className="info-box">
                  ...
                  <p>
                    ...
                    has multiple schemas that map to well-known categories of
                    listings like housing, auto, and services.
                  </p>
          ...
          <div className="step-container schema-details">
            <div className="row flex-sm-row-reverse">
              <div className="col-md-5 offset-md-2">
                <div className="info-box">
                  <div>
                    <h2>How it works</h2>Origin uses a Mozilla project called{" "}
                    <a
                    ...
                    to validate your listing according to standard rules. This
                    standardization is key to allowing unaffiliated entities to
                    read and write to the same data layer.<br />
                    <br />Be sure to give your listing an appropriate title and
                    ...
                    <a
                      ...
                      target="_blank"
                    >
                      View the <code>{this.state.selectedSchema.name}</code>{" "}
                      schema
                    </a>
                  </div>
                  <div className="info-box-image">
          ...
          <div className="step-container listing-preview">
            {this.state.step === this.STEP.METAMASK && (
              <Modal backdrop="static" isOpen={true}>
                <div className="image-container">
                  <img
                    src="/images/spinner-animation.svg"
                    role="presentation"
                  />
                </div>
            ...
            <div className="row flex-sm-row-reverse">
              <div className="col-md-5">
                <div className="info-box">
                  <div>
                    <h2>What happens next?</h2>When you hit submit, a JSON
                    object representing your listing will be published to{" "}
                    <a
                      target="_blank"
                      rel="noopener noreferrer"
                      href="https://ipfs.io"
                    ...
                    and the content hash will be published to a listing smart
                    contract running on the Ethereum network.<br />
                    <br />Please review your listing before submitting. Your
                    listing will appear to others just as it looks on the window
                    to the left.
                  </div>
                </div>
              </div>
