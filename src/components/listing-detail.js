...
class ListingsDetail extends Component {
  ...
  async loadPurchases() {
    ...
    for (let i = 0; i < length; i++) {
      let purchaseAddress = await origin.listings.purchaseAddressByIndex(
        address,
        i
      )
  ...
  async handleBuyClicked() {
    ...
    try {
      const transactionReceipt = await origin.listings.buy(
        this.state.address,
        unitsToBuy,
        totalPrice
      )
          ...
          <div className="row">
            <div className="col-12 col-md-8 detail-info-box">
              ...
              {!!this.state.unitsAvailable &&
                this.state.unitsAvailable < 5 && (
                  <div className="units-available text-danger">
                    Just {this.state.unitsAvailable.toLocaleString()} left!
                  </div>
                )}
              {this.state.ipfsHash && (
            ...
            <div className="row">
              <div className="col-12 col-md-8">
                ...
                <div className="reviews">
                  <h2>
                    Reviews <span className="review-count">57</span>
                  </h2>
