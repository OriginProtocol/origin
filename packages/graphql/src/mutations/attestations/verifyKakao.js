...
async function verifyKakao(_, { identity, authUrl, redirect, code }) {
  ...
  if (!authUrl) {
    const getAuthUrl = `${bridgeServer}/api/attestations/kakao/auth-url`
  ...
  if (code) {
    return new Promise(async resolve => {
      const url = `${bridgeServer}/api/attestations/kakao/verify`
