    ...
    return (
      <>
        <div className="custom-domain">
          ...
          <p>The A record should be for the custom domain or subdomain you want to use, for example <i>dapp.yourdomain.com</i>. The TXT record should then be that hostname prefixed with <i>config.</i>, for example <i>config.dapp.yourdomain.com.</i></p>
