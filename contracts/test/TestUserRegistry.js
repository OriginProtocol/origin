...
const ClaimHolderPresigned = artifacts.require("./dentity/ClaimHolderPresigned.sol")
...
contract("UserRegistry", accounts => {
  ...
  it("should be able to create a user with claims", async function() {
    ...
    let newUserEvent = createWithClaims.logs.find(
      e => e.event == "NewUser"
    )
    ...
    let claimId = web3Utils.soliditySha3(attestation_1.issuer, attestation_1.claimType)
